...
function initNavbar() {
  ...
  if ($mobileNavItems.length) {
    $mobileNavItems.each(function () {
      ...
      var $mobileNav = Object(_utility__WEBPACK_IMPORTED_MODULE_0__["$"])(Object(_utility__WEBPACK_IMPORTED_MODULE_0__["$"])(this).attr('data-nav-mobile'));

      // insert into mobile nav
      $mobileNav.find('.nk-navbar-mobile-content > ul.nk-nav').append($nav);
    });
    var $nav = Object(_utility__WEBPACK_IMPORTED_MODULE_0__["$"])('.nk-navbar-mobile-content > ul.nk-nav');
    ...
    $nav.find('.nk-mega-item > .dropdown').each(function () {
      var $drop = Object(_utility__WEBPACK_IMPORTED_MODULE_0__["$"])(this).children('ul').addClass('dropdown');
...
function initNavbarDropEffect1() {
  var self = this;
  var $navbars = Object(_utility__WEBPACK_IMPORTED_MODULE_0__["$"])('.nk-navbar-side, .nk-navbar-full');

  // add back item for dropdowns
  $navbars.find('.dropdown').prepend("<li class=\"bropdown-back\"><a href=\"#\">".concat(self.options.templates.secondaryNavbarBackItem, "</a></li>"));
...
function initCounters() {
  ...
  var $numberCount = Object(_utility__WEBPACK_IMPORTED_MODULE_0__["$"])('.nk-count:not(.nk-progress)');
...
function initGIF() {
  ...
  Object(_utility__WEBPACK_IMPORTED_MODULE_0__["$"])('.nk-gif').each(function () {
    var $this = Object(_utility__WEBPACK_IMPORTED_MODULE_0__["$"])(this);
    // add toggle button
    $this.append("<a class=\"nk-gif-toggle\">".concat(self.options.templates.gifIcon, "</a>"));
...
function initAudioPlayer() {
  ...
  /* Plain audio players */
  var $playersPlain = Object(_utility__WEBPACK_IMPORTED_MODULE_0__["$"])('.nk-audio-plain');
  ...
  if (typeof Hammer !== 'undefined') {
    ...
    $progresses.each(function () {
      ...
      HammerProgress.on('pan press pressup', function (e) {
        ...
        $curProgres[0].style.width = "".concat(progressCurW * 100, "%");
...
function initImageSlider() {
  ...
  $sliders.each(function () {
    ...
    // Countdown.
    var $countdown = Object(_utility__WEBPACK_IMPORTED_MODULE_0__["$"])('<div class=""></div>');
...
function initInstagram() {
  ...
  $instagram.each(function () {
    ...
    $this.html("<div class=\"col-12\">".concat(options.loadingText, "</div>"));
...
function initTwitter() {
  ...
  $twtFeeds.each(function () {
    ...
    // Set loading
    $this.html("<span>".concat(options.loadingText, "</span>"));
...
function initPluginPhotoswipe() {
  ...
  _utility__WEBPACK_IMPORTED_MODULE_0__["$body"].append(markup);
...
/***/ })
/******/ ]);
//# sourceMappingURL=goodgames.min.js.map
